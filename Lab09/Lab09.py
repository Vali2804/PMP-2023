...
if __name__ == '__main__':
    ...
    gre_mean= gre_scores.mean()
    gre_std = gre_scores.std()
    gpa_mean= gpa_scores.mean()
    gpa_std = gpa_scores.std()
    ...
    pm.plot_posterior(trace, var_names=['beta_1', 'beta_2'], color='Green', ref_val=0)
...
#exercitiul 3
    ...
    with logistic_model:
        post_pred_1 = pm.sample_posterior_predictive(trace, samples_dims=2000, var_names=['admission'], new_data=new_data_1)
